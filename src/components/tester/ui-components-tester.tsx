          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  이 카드는 기본(default) 사이즈의 shadcn/ui Card
                  컴포넌트입니다.
                </CardDescription>
                <CardAction>
              ...
              <CardContent>
                <p className="text-xs leading-relaxed">
                  이 영역은 CardContent 컴포넌트의 내부 본문 콘텐츠입니다.
                  다양한 레이아웃 요소와 텍스트를 배치하기에 용이합니다.
                </p>
              </CardContent>
            ...
            <Card size="sm">
              ...
              <CardContent>
                <p className="text-muted-foreground text-[11px] leading-normal">
                  여백과 글자 크기가 본문 폭에 맞게 조금 더 조밀하게 조정되어
                  정보 밀도가 높은 UI 레이아웃에 최적화되어 있습니다.
                </p>
              </CardContent>
          ...
          <div className="max-w-md space-y-4">
            <div className="space-y-1.5">
              <label
                ...
                className="text-foreground/80 block text-xs font-semibold"
              >
              ...
              <div className="relative">
                <input
                  ...
                  className="border-input bg-card text-foreground placeholder:text-muted-foreground focus:border-primary focus:ring-ring w-full rounded-md border py-2.5 pr-4 pl-9 text-xs transition-all focus:ring-2 focus:outline-none"
                />
                <Search className="text-muted-foreground pointer-events-none absolute top-3.5 left-3 h-3.5 w-3.5" />
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent className="pt-4">
          <div className="max-w-2xl space-y-3">
            ...
            <Card className="border-success/20 bg-success-bg text-success border text-xs">
              <CardContent className="flex items-start gap-3 p-3.5">
                <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0" />
                <div>
                  <span className="mb-0.5 block font-bold">
                    성공 상태 알림 (Success Status)
                  </span>
                  <span className="opacity-90">
                    작업이 완벽하게 완료되었습니다. 시스템이 정상 운영 중입니다.
                  </span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-warning/20 bg-warning-bg text-warning border text-xs">
              <CardContent className="flex items-start gap-3 p-3.5">
                <AlertTriangle className="mt-0.5 h-4 w-4 shrink-0" />
                <div>
                  <span className="mb-0.5 block font-bold">
                    주의 경고 알림 (Warning Status)
                  </span>
                  <span className="opacity-90">
                    네트워크 리소스 상태에 유의하세요. 보조 설정 점검이
                    필요합니다.
                  </span>
                </div>
              </CardContent>
            ...
            <Card className="border-destructive/20 bg-destructive/10 text-destructive border text-xs">
              <CardContent className="flex items-start gap-3 p-3.5">
                <XCircle className="mt-0.5 h-4 w-4 shrink-0" />
                <div>
                  <span className="mb-0.5 block font-bold">
                    치명적 오류 알림 (Destructive Status)
                  </span>
                  <span className="opacity-90">
                    해당 작업을 수행하는 동안 내부 검증에 실패했습니다.
                  </span>
                </div>
              </CardContent>
            </Card>
